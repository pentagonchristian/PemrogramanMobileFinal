package com.pentagonchristian.finalmobile.ui.adapters;
...
public class CastAdapter extends RecyclerView.Adapter<com.pentagonchristian.finalmobile.ui.adapters.CastAdapter.CastViewHolder> {
    ...
    @NonNull
    @Override
    public com.pentagonchristian.finalmobile.ui.adapters.CastAdapter.CastViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.item_cast_recycler, parent, false);
        return new com.pentagonchristian.finalmobile.ui.adapters.CastAdapter.CastViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull com.pentagonchristian.finalmobile.ui.adapters.CastAdapter.CastViewHolder holder, int position) {
